  ...
  if (msg.results && msg.results.length > 0) {
    ...
    if (msg.results[0].final) {
      ...
      var params ;
       ...
       // send MQTT messagehttps://hub.jazz.net/pipeline/mvk/speech-to-text-iotgame
        url = '/mqtt';
       ...
       // send POST message
//       alert("POST="+baseString);
 //       $('#resultsText').val(baseString + "POST");
       var url = 'https://iotgamenr.mybluemix.net/sptotext';
       var tokenRequest = new XMLHttpRequest();
       tokenRequest.open('POST', url, false);// "Content-type" : "application/json"
        tokenRequest.setRequestHeader("Access-Control-Allow-Origin", "*");
